// Shared location hierarchy: Continent → Country → State/Province/Territory → City.
...
export const GEO = {
  ...
  Europe: {
    ...
    Belgium: { Brussels: ["Brussels"], Flanders: ["Antwerp"] },
    ...
    Germany: { Berlin: ["Berlin"], Bavaria: ["Munich"], Hamburg: ["Hamburg"], "North Rhine-Westphalia": ["Cologne"] },
    Greece: { Attica: ["Athens"] },
    Hungary: { Budapest: ["Budapest"] },
    Iceland: { "Capital Region": ["Reykjavík"] },
    Ireland: { Leinster: ["Dublin"] },
    Italy: { Lazio: ["Rome"], Lombardy: ["Milan"], Piedmont: ["Turin"] },
    Latvia: { Riga: ["Riga"] },
    ...
    Portugal: { Lisbon: ["Lisbon"], Porto: ["Porto"], Braga: ["Braga"] },
    Romania: { Bucharest: ["Bucharest"] },
    Serbia: { Belgrade: ["Belgrade"] },
    Slovakia: { Bratislava: ["Bratislava"] },
    Slovenia: { Ljubljana: ["Ljubljana"] },
    Spain: { Madrid: ["Madrid"], Catalonia: ["Barcelona"], Valencia: ["Valencia"], Andalusia: ["Seville"] },
    Sweden: { Stockholm: ["Stockholm"] },
    Switzerland: { Zürich: ["Zürich"], Geneva: ["Geneva"], Basel: ["Basel"] },
    "United Kingdom": { England: ["London", "Manchester", "Birmingham", "Leeds"], Scotland: ["Glasgow", "Edinburgh"], Wales: ["Cardiff"] },
  },
  Asia: {
