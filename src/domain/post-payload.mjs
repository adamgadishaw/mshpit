...
export function buildReviewCreateBody(post) {
  ...
  return {
    ...
    city: online ? "" : clean(post.city, { max: LIMITS.city }),
    eventAddress: online ? null : clean(post.eventAddress, { max: LIMITS.eventAddress }) || null,
...
export function buildReviewEditBody(changes) {
  ...
  return {
    ...
    city: online ? "" : clean(changes.city, { max: LIMITS.city }),
    eventAddress: online ? null : clean(changes.eventAddress, { max: LIMITS.eventAddress }) || null,
