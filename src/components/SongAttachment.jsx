...
// 16:9 thumbnail with a play button over it and the title below, so it reads as
// real media in the post rather than a tiny sidebar chip. The validated video id
...
export default function SongAttachment({ song, onPlay, compact = false }) {
  ...
  const a11y = { accessibilityRole: onPlay ? "button" : undefined, accessibilityLabel: `Play ${track.title} by ${track.artist} in your Pit player` };
    ...
    <Pressable style={styles.card} onPress={press} {...a11y}>
      <View style={styles.stage}>
        ...
        <View style={styles.badge} pointerEvents="none">
          ...
          <Text style={styles.badgeTxt}>WATCH ON PIT</Text>
        </View>
      </View>
