...
const styles = StyleSheet.create({
  ...
  topSignupButton: { minHeight: 40, alignItems: "center", justifyContent: "center", paddingHorizontal: 14, borderRadius: radius.pill, backgroundColor: colors.amberStrong, borderWidth: 1, borderBottomWidth: 1, borderColor: colors.amber, borderBottomColor: colors.accentEdge, ...shadow.control },
  ...
  tgOn: { backgroundColor: colors.surfaceAlt, boxShadow: "inset 0 1px 0 rgba(255,255,255,0.06), 0 1px 2px rgba(0,0,0,0.3)" },
  tgTxt: { color: colors.textDim, fontSize: 11, fontWeight: "700" },
  tgTxtOn: { color: colors.text },
