...
test("server failure codes normalize to stable PIT references", () => {
  const expected = {
    ...
    ARTIST_LEGACY_READ_ONLY: "PIT-REQ-003",
    ARTIST_PAGE_EXISTS: "PIT-REQ-003",
    ARTIST_PAGE_LIMIT: "PIT-REQ-003",
    ARTIST_IDENTITY_REVIEW_REQUIRED: "PIT-REQ-003",
    ACCOUNT_CHANGED: "PIT-REQ-003",
    ALREADY_VERIFIED: "PIT-REQ-003",
    ...
    ARTIST_CAMPAIGN_LIMIT: "PIT-RATE-001",
    ...
    PAGE_HEAD_UNAVAILABLE: "PIT-SVC-001",
