  ...
  return (
    <PolicyScreen
      ...
      sections={[
        ...
        { h: "Data retention & security", p: `Account and content data is kept while needed to operate the account and service. Raw first-party product analytics is automatically limited to a rolling 30-day period by default and is deleted earlier when you opt out or delete your account. If an artist search returns no match, the submitted artist name may remain in a bounded staff enrichment queue for up to 30 days. ${MEDIA_AND_SESSION_SECURITY_DISCLOSURE} When you delete content or your account, active database records are removed or scrubbed and Pit-owned uploads are durably queued for active object-storage deletion; cleanup retries automatically and can take additional time. Separate backup copies remain until the configured retention period ends, or longer when legally required. Passwords are hashed, signed-in requests use HTTPS in production, and access is limited, but no online service can promise perfect security.` },
