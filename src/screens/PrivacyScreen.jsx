...
export default function PrivacyScreen({ onClose }) {
  return (
    <PolicyScreen
      ...
      sections={[
        { h: "Information you give us", p: "Account details (name, email, password, and the city you choose), your profile (bio, avatar, genres, favorite artists, playlists), feed preferences such as Not for me, and everything you create on Pit: reviews, ratings, photos, comments, fan-club and lounge messages, direct messages, follows, and who/what you engage with." },
        ...
        { h: "Data retention & security", p: "Account and content data is kept while needed to operate the account and service. Raw first-party product analytics is automatically limited to a rolling 30-day period by default and is deleted earlier when you opt out or delete your account. If an artist search returns no match, the submitted artist name may remain in a bounded staff enrichment queue for up to 30 days. When you delete content or your account, active database records are removed or scrubbed and Pit-owned uploads are durably queued for active object-storage deletion; cleanup retries automatically and can take additional time. Separate backup copies remain until the configured retention period ends, or longer when legally required. Passwords are hashed, sessions use secure signed-in requests over HTTPS in production, and access is limited, but no online service can promise perfect security." },
