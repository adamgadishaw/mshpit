  ...
  return (
    <PolicyScreen
      ...
      sections={[
        ...
        { h: "Data retention & security", p: "Account and content data is kept while needed to operate the account and service. Raw first-party product analytics is automatically limited to a rolling 30-day period by default and is deleted earlier when you opt out or delete your account. Passwords are hashed, sessions use secure signed-in requests over HTTPS in production, and access is limited, but no online service can promise perfect security." },
