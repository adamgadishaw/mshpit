  ...
  return (
    <PolicyScreen
      ...
      sections={[
        ...
        { h: "Feed history and post view counts", p: "When you are signed in, Pit privately records that your account has seen a post and the first and most recent time it was seen. This core feed history is separate from optional product analytics: it lowers recently seen posts when you refresh so your For You feed does not repeat the same cards. A post can show an aggregate count of unique signed-in members who saw it, but Pit does not show authors or other members a viewer list, your viewing times, or your private feed history. Author self-views, guests, blocked relationships, and unavailable posts are not counted." },
        ...
        { h: "Your choices & rights", p: `You can edit your profile, download a portable account backup, delete content, block accounts, turn product analytics off, or permanently delete your account from Settings. Turning analytics off deletes that account's existing product-event rows and prevents new ones from being recorded; it does not disable the private feed history used to rotate already-seen posts. Your account backup includes that feed history, and deleting your account removes the account-linked rows. ${PROFILE_SEARCH_INDEXING_DISCLOSURE} Depending on where you live, additional access, correction, deletion, objection, or restriction rights may apply; contact the team to make a request.` },
