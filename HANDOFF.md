...
from the existing `pointsTier()` in `src/domain/badges.mjs` (Newcomer→Legend, driven
...
- Provider-neutral tracks now use `src/domain/trackIdentity.mjs::trackKey` (`artist|title`
